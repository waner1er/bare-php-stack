...
class TextareaInput extends AbstractInput
{
    ...
    protected ?string $wysiwygType = null;
    ...
    public function enableWysiwyg(string $type = 'tinymce'): self
    {
        $this->wysiwyg = true;
        $this->wysiwygType = $type;
        return $this;
    }
    ...
    public function validate(mixed $value): array
    {
        ...
        $length = mb_strlen(strip_tags($value)); // important pour WYSIWYG
    ...
    public function render(): string
    {
        ...
        $wysiwygType = $this->wysiwygType ? 'data-wysiwyg-type="' . htmlspecialchars($this->wysiwygType) . '"' : '';
